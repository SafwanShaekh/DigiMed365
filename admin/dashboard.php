                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                <h4 class="fs-16 mb-1">Greetings, <?php  echo $row['fullname'];?>!!!</h4>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        ...
                                                        <a href="appointment-history.php" class="text-decoration-underline text-muted">View all Appointments</a>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        ...
                                                        <a href="manage-doctors.php" class="text-decoration-underline text-muted">View all Doctors</a>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Recent Doctor Requests</h4>
                                            </div><!-- end card header -->
