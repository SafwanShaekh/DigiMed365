...
<head>
    ...
    <meta charset="utf-8" />
    <title>Dashboard | DigiMed365 </title>
                        ...
                        <div class="row">
                            ...
                            <div class="row g-4 mb-3 card-header">
                                            <div class="col-sm-auto">
                                                <div>
                                                    <h4 class="card-title mb-0">ڈاکٹر اسپیشلائزیشن شامل کریں۔</h4>
                                                </div>
                                            </div>
                                            <div class="col-sm">
                                                <div class="d-flex justify-content-end">
                                                    <a class="btn btn-success add-btn" href="manage-doctors.php"> فہرست دیکھیں</a>
                                                </div>
                                            </div>
                                        </div>
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="doctor-name-input">ڈاکٹر کا نام</label>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="doctor-name-input">ڈاکٹر کا ای میل</label>
                                            <input type="hidden" class="form-control" id="formAction" name="formAction"
                                                value="add">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="password-input">پاس ورڈ</label>
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                <label class="form-label" for="doctor-name-input">ڈاکٹر سپیسیلائزیشن</label>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="doctor-name-input">تعلیمی
                                                قابلیت</label>
                                            <input type="hidden" class="form-control" id="formAction" name="formAction"
                                                value="add">
                                            <input type="text" class="form-control d-none" id="product-id-input">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="doctor-name-input">کام کا تجربہ</label>
                                            <input type="hidden" class="form-control" id="formAction" name="formAction"
                                                value="add">
                                            <input type="text" class="form-control d-none" id="product-id-input">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="doctor-name-input">سرجریز
                                                مکمل</label>
                                            <input type="hidden" class="form-control" id="formAction" name="formAction"
                                                value="add">
                                            <input type="text" class="form-control d-none" id="product-id-input">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="doctor-name-input">مطمئن مریض</label>
                                            <input type="hidden" class="form-control" id="formAction" name="formAction"
                                                value="add">
                                            <input type="text" class="form-control d-none" id="product-id-input">
                                        ...
                                        <div class="mb-3">
                                            <label for="avatar">ڈاکٹر کی تصویر</label>
                                            <input type="file" name="doctoravatar" id="" value="AVATAR">
                                        </div>
                                        <div class="mt-5 mb-3">
                                            <button class="btn btn-success w-100" name="submit" type="submit">ڈاکٹر کو شامل کریں۔</button>
                                        </div>
