                ...
                <div class="container-fluid">
                    <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label" for="doctor-name-input">سپیسیلائزیشن کا نام</label>
                                                            ...
                                                            <div class="invalid-feedback">براہ کرم ڈاکٹر کی تخصیص درج کریں۔
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="text-start">
                                                                <button type="submit" name="submit" class="btn btn-success">جمع کرائیں</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">ڈاکٹر اسپیشلائزیشن</h4>
                                </div><!-- end card header -->
