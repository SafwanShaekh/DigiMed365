    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-5 text-lg">ماہر ڈاکٹرز</h1>
  	  ...
  	  <div class="row justify-content-center">
             <div class="col-lg-6 text-center">
                <div class="section-title">
                    ...
                    <p>آپ کی دیکھ بھال کے لیے ہمارے پاس انڈسٹری کے بہترین ہیلتھ کیئر پروفیشنلز ہیں۔🏥</p>
                </div>
            </div>
        </div>
...
<div class="col-12 text-center  mb-5">
    <div class="btn-group btn-group-toggle" data-toggle="buttons">
        <label class="btn active">
            <input type="radio" name="shuffle-filter" value="all" checked="checked">تمام ڈاکٹرز
        </label>
        <?php
		...
		<div class="row">
			<div class="col-lg-7">
				<div class="cta-content">
					...
					<h2 class="mb-5 text-lg">ہم آپ کو صحت مند ہونے کا<span class="title-color">موقع فراہم کرتے ہوئے خوش ہیں</span></h2>
					<?php	
