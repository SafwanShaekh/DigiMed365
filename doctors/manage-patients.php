...
//code for delete
if (isset($_GET['del'])) {
    $did = $_GET['del']; // Corrected variable name
    
    // Rest of the code...
    $sqli = mysqli_query($conn, "DELETE FROM `appointments` WHERE id = '$did'");
    if ($sqli == true) {
        $_SESSION['successmsg'] = "Patient removed successfully!";
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="remove">
                        <a href="manage-health.php" class="btn btn-sm btn-info remove-item-btn">Manage Patient Health Vitals</a>
                    </div>
                                    </div>
                                </div><!-- end card header -->
    ...
    <?php include_once "include/setting.php"?>
       ...
       <script>
            ...
            searchBar.addEventListener('keyup', ()=>{
                ...
                xhr.open("POST", "include/patient-search.php", true);
            ...
            // let start Ajax
            let xhr = new XMLHttpRequest(); // creating XML object
            xhr.open("GET", "include/patient.php", true);
            xhr.addEventListener('load', ()=>{
                if(xhr.readyState === XMLHttpRequest.DONE){
                    if(xhr.status === 200){
                        let data = xhr.response;
