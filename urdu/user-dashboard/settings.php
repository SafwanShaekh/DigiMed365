                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-5">
                                        <div class="flex-grow-1">
                                            <h5 class="card-title mb-0">اپنی پروفائل مکمل کریں</h5>
                                        </div>
                                            ...
                                            <form action="" method="POST">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            <?php echo($msg);?>
                                                            <label for="firstnameInput" class="form-label">پورا نام</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="phonenumberInput" class="form-label">فون نمبر</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="emailInput" class="form-label">ای میل ایڈریس</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="designationInput" class="form-label">ای میل ایڈریس</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="websiteInput1" class="form-label">شہر</label>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            <label for="cityInput" class="form-label">شہر</label>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            <label for="countryInput" class="form-label">ملک</label>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            <label for="zipcodeInput" class="form-label">زپ کوڈ</label>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="mb-3 pb-2">
                                                            <label for="exampleFormControlTextarea" class="form-label">اپنے طبی مسئلے کو بیان کریں</label>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <?php echo ($msg) ?>
                                                            <button type="submit" name="update"class="btn btn-primary">معلومات کو اپ ڈیٹ کریں</button>
                                                            <a href="profile.php">
                                                                <button type="button" class="btn btn-soft-success">منسوخ کریں</button>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                        ...
                                        <div class="tab-pane" id="changePassword" role="tabpanel">
                                            ...
                                            <form action="" method="POST">
                                                <div class="row g-2">
                                                    <div class="col-lg-4">
                                                        <div>
                                                            <label for="oldpasswordInput" class="form-label">پرانا پاس ورڈ</label>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div>
                                                            <label for="newpasswordInput" class="form-label">نیا پاس ورڈ</label>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div>
                                                            <label for="confirmpasswordInput" class="form-label">پاس ورڈ کی تصدیق کریں</label>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="text-end">
                                                            <button type="submit" name="passSub" class="btn btn-success">پاس ورڈ تبدیل کریں</button>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                </div>
