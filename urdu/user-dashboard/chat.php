                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Contact with Doctors</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Medical</a></li>
                                        <li class="breadcrumb-item active">your booking doctors</li>
                                    </ol>
                                </div>
                    ...
                    <div class="wrapper mb-5 mt-3">
                        <section class="chat-area">
                            <header>
                                <?php
                                $doctor_name = mysqli_real_escape_string($conn, $_GET['doctor_name']);
                                $sql = mysqli_query($conn, "SELECT * FROM doctors WHERE doctor_name = '{$doctor_name}'");
                                if (mysqli_num_rows($sql) > 0) {
                                    $row = mysqli_fetch_assoc($sql);
                                    $user_id = $row['id'];
                                    ?>
                                    <a href="doctors.php" class="back-icon"><i class="fas fa-arrow-left"></i></a>
