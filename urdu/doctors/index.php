                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <h5 class="text-primary">Welcome Doctor !</h5>
                                ...
                                <div class="p-2 mt-4 signin">
                                    <form action="index.php" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="doctor-email" class="form-control" id="email" placeholder="Enter username">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label" for="password-input">Your Password:</label>
