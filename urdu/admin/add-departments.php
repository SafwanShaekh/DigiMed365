                                    ...
                                    <div class="card-body">
                                        <div class="row g-4 mb-3 card-header">
                                            <div class="col-sm-auto">
                                                <div>
                                                    <h4 class="card-title mb-0">محکموں کو شامل کریں۔</h4>
                                                </div>
                                            </div>
                                            <div class="col-sm">
                                                <div class="d-flex justify-content-end">
                                                    <a class="btn btn-success add-btn" href="manage-departments.php">فہرست دیکھیں</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="Department-name-input">محکمہ نام</label>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="doctor-name-input">محکمہ کی تفصیل</label>
                                            <input type="hidden" class="form-control" id="formAction" name="formAction"
                                                value="add">
                                            <input type="text" class="form-control d-none" id="product-id-input">
                                        ...
                                        <div class="mt-5 mb-3">
                                            <button class="btn btn-success w-100" name="submit" type="submit">محکموں کو شامل کریں۔</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- end card -->
