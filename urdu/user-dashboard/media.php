...
include('../config.php');
$fetch = "SELECT * FROM vault WHERE `file_extension` LIKE '%png' OR `file_extension` LIKE '%jpg' OR `file_extension` LIKE '%jpeg' ;";
                                                    ...
                                                    <div class="container-fluid">
                                                        ...
                                                        <div id="folder-list" class="mb-2">
                                                            <div class="row justify-content-beetwen g-2 mb-3">
                                                                ...
                                                                <!--end col-->
                                                                <div>
                                                                    <form action="vault.php" method="post" enctype="multipart/form-data">
                                                                                                    ...
                                                                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                                                                        <div class=" card" style="box-shadow: none;">
                                                                                                            <div class="gallery-container">
                                                                                                                <a class="image-popup" href="<?php echo ($row['file']); ?>" title="">
                                                                                                                    <img style="width:150px !important; height:200px;" class="gallery-img img-fluid mx-auto" src="<?php echo ($row['file']); ?>" alt="">
                                                                                                                    <div class="gallery-overlay">
                                                                                                                        <h5 class="overlay-caption"><?php echo ($row['file_name']); ?></h5>
                                                                                                                        <div class="dropdown">
