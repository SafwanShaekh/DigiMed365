                                                ...
                                                <div class="row justify-content-beetwen g-2 mb-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <form action="delete.php" method="post">
                                                            <button type="submit" name="submit" class="btn btn-danger">سب کو ہمیشہ کے لیے مٹا کر دیں۔</button>
                                                                                                ...
                                                                                                <td>
                                                                                                    <div class="dropdown">
                                                                                                        ...
                                                                                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink15">
                                                                                                            ...
                                                                                                            <li><a class="dropdown-item" href="delete.php?id=<?php echo ($row['item_id']); ?>"><i class="ri-delete-bin-5-line me-2 align-middle text-muted"></i>مٹا دیں</a>
                                                                                                            </li>
                                                                                                        </ul>
                                                                                                    </div>
                                                                                                </td>
