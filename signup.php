...
if(isset($_POST['submit'])){
	...
	if ($usercheck_result->num_rows > 0) {
		...
		$signup = "INSERT INTO `users`(`fullname`, `email`, `password`, `phone`, `cnic`) VALUES ('$fullname','$email','$password','$phone', '$cnic')";
			...
			<div class="row justify-content-center">
				<div class="col-lg-6">
					<div class="section-title text-center">
						<h2 class="text-md mb-2">Signup</h2>
						<div class="divider mx-auto my-4"></div>
						<p class="mb-5">Please Signup in order to Access all Features of DigiMed365</p>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<?php echo($msg);?>
					<form id="contact-form" class="contact__form " method="POST" action="signup.php">
						...
						<div style="text-align: center;">
							<input class="btn btn-main btn-round-full" name="submit" type="submit" value="Proceed to Signup"></input>
						</div>
					</form>
				</div>
			</div>
