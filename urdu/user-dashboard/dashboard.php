...
$fetch = "SELECT * FROM `appointments` where `fullname` = '$username' ";
$result = $conn->query($fetch);


$healthvitalsquery = "SELECT * FROM `health_vitals` WHERE `user_name` = '$username'";
$healthvitalsquery_exec = mysqli_query($conn,$healthvitalsquery);
$healthvitals_array = $healthvitalsquery_exec->fetch_assoc();
?>
<!-- removeNotificationModal -->
        ...
        <div class="main-content">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo($healthvitals_array['bmi'])?>">0</span>
                                                        </h4>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo($healthvitals_array['weight'])?>">0</span>kg</h4>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo($healthvitals_array['pulse_rate'])?>">0</span>bpm
                                                        </h4>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo($healthvitals_array['body_temp'])?>">0</span>°C
                                                        </h4>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">میری ملاقاتیں</h4>
                                                ...
                                                <div class="table-responsive table-card">
                                                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                        <thead class="text-muted table-light">
                                                            <tr>
                                                                <th scope="col">بکنگ آئی ڈی</th>
                                                                <th scope="col">محکمہ</th>
                                                                <th scope="col">ڈاکٹر</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-grow-1"><?php echo $row['dept'] ?></div>
                                                                    </div>
                                                                </td>
                                                                
                                                                <td>
                                                                    <span class="text-success"><?php echo $row['doctor'] ?></span>
                                                                </td>
                                                                <td>
                                                                    <span class="badge badge-soft-success"><?php echo $row['appointment_date'] ?></span>
                                                                </td>
                                                                <td>
                                                                    <span class="badge badge-soft-success"><?php echo $row['appointment_time'] ?></span>
                                                                </td>
                                                            </tr>
                                                            <?php 
                                                            }
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © DigiMed365.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Developed by by Safwan Shaekh
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
        <div class="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
            <h5 class="m-0 me-2 text-white">Customize Your Dashboard</h5>
