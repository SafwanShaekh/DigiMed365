...
if(isset($_GET['del'])){
    $did=$_GET['id'];
    $sqli = mysqli_query($conn,"DELETE FROM contact WHERE id = '$did'");
    
    if($sqli) {
        $_SESSION['successmsg'] = "message remove successfully !!";
...
<head>
    ...
    <meta charset="utf-8" />
    <title>DigiMed365 | Contact Forms</title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Manage Contact Forms</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">DigiMed365</a></li>
    ...
    <?php include_once "include/setting.php"?>
       ...
       <script>
            ...
            const doctorsList = document.querySelector(".main-table .doctor-list");
            ...
            searchBar.addEventListener('keyup', ()=>{
                ...
                xhr.open("POST", "include/contact-search.php", true);
            ...
            // let start Ajax
            let xhr = new XMLHttpRequest(); // creating XML object
            xhr.open("GET", "include/contact.php", true);
            xhr.addEventListener('load', ()=>{
                if(xhr.readyState === XMLHttpRequest.DONE){
                    if(xhr.status === 200){
                        let data = xhr.response;
