                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">ڈاکٹرز سے رابطہ کریں</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">ڈیش بورڈ</a></li>
                    ...
                    <div class="wrapper mb-5 mt-3">
                        <section class="users">
                            ...
                            <div class="search">
                                <span class="text">مکالمہ کے لئے ایک ڈاکٹر کا انتخاب کریں</span>
    ...
    <script>
        const searchBar = document.querySelector(".users .search input"),
            ...
            setInterval(() =>{
                // let start Ajax
                let xhr = new XMLHttpRequest(); // creating XML object
                xhr.open("GET", "include/doctor.php", true);
                xhr.addEventListener('load', ()=>{
                    if(xhr.readyState === XMLHttpRequest.DONE){
                        if(xhr.status === 200){
                            let data = xhr.response;
