...
if(isset($_GET['del'])){
    $labid=$_GET['id'];
    $sqli = mysqli_query($conn,"DELETE FROM laboritories WHERE id = '$labid'");
                                    ...
                                    <div class="listjs-table" id="customerList">
                                        <div class="row g-4 mb-3">
                                            <div class="col-sm-auto">
                                                <div>
                                                    <a class="btn btn-success add-btn" href="add-labs.php"><i
                                                        class="ri-add-line align-bottom me-1"></i> Add Laboratory </a>
                                                </div>
                                            </div>
    ...
    <?php include_once "include/setting.php"?>
       ...
       <script>
            ...
            searchBar.addEventListener('keyup', ()=>{
                ...
                xhr.open("POST", "include/lab-search.php", true);
            ...
            // let start Ajax
            let xhr = new XMLHttpRequest(); // creating XML object
            xhr.open("GET", "include/lab.php", true);
            xhr.addEventListener('load', ()=>{
                if(xhr.readyState === XMLHttpRequest.DONE){
                    if(xhr.status === 200){
                        let data = xhr.response;
