...
if(isset($_GET['del'])){
    $did=$_GET['id'];
    $sqli = mysqli_query($conn,"DELETE FROM departments WHERE dept_id = '$did'");
    
    if($sqli) {
        $_SESSION['successmsg'] = "Doctor remove successfully !!";
...
<body>
                                    ...
                                    <div class="listjs-table" id="customerList">
                                        <div class="row g-4 mb-3">
                                            <div class="col-sm-auto">
                                                <div>
                                                    <a class="btn btn-success add-btn" href="add-departments.php"><i
                                                        class="ri-add-line align-bottom me-1"></i> Add Departments </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="table-responsive table-card mt-3 mb-1">
                                            <table class="table align-middle table-nowrap main-table" id="customerTable">
                                                ...
                                                <tbody class="list department-list">
    ...
    <?php include_once "include/setting.php"?>
       ...
       <script>
            ...
            const doctorsList = document.querySelector(".main-table .department-list");
            ...
            searchBar.addEventListener('keyup', ()=>{
                ...
                xhr.open("POST", "include/depart-search.php", true);
            ...
            // let start Ajax
            let xhr = new XMLHttpRequest(); // creating XML object
            xhr.open("GET", "include/depart.php", true);
            xhr.addEventListener('load', ()=>{
                if(xhr.readyState === XMLHttpRequest.DONE){
                    if(xhr.status === 200){
                        let data = xhr.response;
