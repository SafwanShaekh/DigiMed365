...
if (isset($_GET['id'])) {
    $dept_id = $_GET['id'];
    $fetch = "SELECT * FROM `departments` WHERE `dept_id` = '$dept_id'";
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-5 text-lg"><?php echo ($row['dept_name']);	?></h1>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					<h3 class="text-md"><?php echo ($row['dept_name']);	?></h3>
					<div class="divider my-4"></div>
					<p><?php echo ($row['dept_description']);	?></p>
					.</p>
