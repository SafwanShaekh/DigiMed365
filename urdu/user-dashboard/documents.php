...
if (isset($_FILES['image'])) {
    ...
    $empty_destination = 'uploads/';
    $image_destination = 'uploads/' . $image_name;
    $upload_Date = date('Y-m-d');
    if ($image_destination == $empty_destination) {
    ...
    $insert = "INSERT INTO `vault`( `file_name`, `file`, `username`, `upload_date`, `file_extension) VALUES ('$image_name ','$image_destination ',' $name','$upload_Date',' $extension')";
...
$fetch = "SELECT * FROM vault WHERE `file_extension` LIKE '%f' OR `file_extension` LIKE '%p' OR `file_extension` LIKE '%X' ;";
            ...
            <div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                <div class="file-manager-sidebar">
                    <div class="p-3 d-flex flex-column h-100">
                        <div class="mb-3">
                            <h5 class="mb-0 fw-semibold fs-16">میرا خزانہ</h5>
                        </div>
                                                ...
                                                <div class="row justify-content-beetwen g-2 mb-3">
                                                    ...
                                                    <div class="col">
                                                        <div class="d-flex align-items-center mb-4">
                                                            <h5 class="card-title flex-grow-1 mb-0">میرا ڈرائیو</h5>
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table
                                                                                ...
                                                                                <tr>
                                                                                        <th scope="col">نام</th>
                                                                                        <th scope="col">قسم</th>
                                                                                        <th scope="col">اپ لوڈ کرنے کی تاریخ</th>
                                                                                        <th scope="col">عمل</th>
                                                                                    </tr>
                                                                                </thead>
                                                                                                ...
                                                                                                <td>
                                                                                                    <div class="dropdown">
                                                                                                        ...
                                                                                                        <ul class="dropdown-menu dropdown-menu-end"
                                                                                                            ...
                                                                                                            <li><a class="dropdown-item" href="<?php echo ($row['file']); ?>" target="_blank"><i class="ri-eye-fill me-2 align-middle text-muted"></i>دیکھیں</a>
                                                                                                                                </li>
                                                                                                                                <li><a class="dropdown-item" href="<?php echo ($row['file']); ?>" download=""><i class="ri-download-2-fill me-2 align-middle text-muted"></i>ڈاؤن لوڈ کریں</a>
                                                                                                                                </li>

                                                                                                                                <li class="dropdown-divider">
                                                                                                                                </li>
                                                                                                                                <li><a class="dropdown-item" href="removed_files.php?id=<?php echo ($row['file_id']); ?>"><i class="ri-delete-bin-5-line me-2 align-middle text-muted"></i>مٹا دیں</a>
                                                                                                                                </li>
                                                                                                        </ul>
                                                                                                    </div>
                                                                                                </td>
                                        ...
                                        <div class="simplebar-content" style="padding: 16px 16px 0px;">
                                            <div id="folder-overview">
                                                ...
                                                <div id="simple_dount_chart"
                                                    ...
                                                    class="apex-charts mt-3" dir="ltr" style="min-height: 330px;">
                                                    <div id="apexchartswyqq6tma"
                                                        class="apexcharts-canvas apexchartswyqq6tma"
                                                        style="width: 0px; height: 330px;"><svg id="SvgjsSvg1034"
                                                            width="0" height="330" xmlns="http://www.w3.org/2000/svg"
